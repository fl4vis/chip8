...
static void chip8_exec_extended(struct chip8 *chip8, unsigned short opcode) {
    ...
    switch(opcode & 0xf000) {
        ...
        // The interpreter increments the SP, then puts the current PC on the top of the stack. The PC is then set to nnn.
        case 0x2000:
        ...
        // The interpreter compares register Vx to kk, and if they are not equal, increments the PC by 2.
        case 0x4000:
            if(chip8->registers.V[x] != kk) {
                chip8->registers.PC += 2;
            }
